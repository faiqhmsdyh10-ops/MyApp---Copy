  ...
  useEffect(() => {
    const fetchAksiDetail = async () => {
      try {
        ...
        const aksiData = data?.find((d) => d.id === parseInt(id));
        if (aksiData) {
          setAksi(aksiData);
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-3xl font-bold text-blue-600 mb-2">Rp 5.000.000</p>
                  <p className="text-sm text-gray-600 mb-3">Target: Rp 10.000.000</p>
